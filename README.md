...
./ambf_simulator -l 100 --plugins libvolumetric_drilling.so --images_path <volumetric_plugin_path>/resources/volumes/ear3/ --prefix plane00 --count 512 --shaders_path <volumetric_plugin_path>/resources/shaders/ --drill_path <volumetric_plugin_path>/resources/volumes/drill_mesh/drillMesh.obj
```
